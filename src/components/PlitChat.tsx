    ...
    <>
      ...
      >
        {isOpen ? (
          ...
          <>
            {/* Plit avatar */}
            <div className="h-7 w-7 rounded-md overflow-hidden border border-accent/60">
              <img src="/mvp/Plit.png" alt="Plit" className="h-full w-full object-cover" />
            </div>
      ...
      >
        ...
        <div className="flex items-center gap-3 border-b border-border px-4 py-3 bg-card/80 backdrop-blur-md">
          {/* Plit avatar */}
          <div className="h-9 w-9 rounded-lg overflow-hidden border border-accent/50">
            <img src="/mvp/Plit.png" alt="Plit" className="h-full w-full object-cover" />
          </div>
